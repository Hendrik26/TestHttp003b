...
export class FormularComponent implements OnInit {
    ...
    write_loc() {
        ...
        this._demosrv.write_local(msg).subscribe(
            ...
            error => {
                console.error('Error saving data in localStorage');
                return false;
            }
        );
    }
    ...
    read_loc() {
        this._demosrv.read_local().subscribe(
            ...
            () => console.log('done load data from localStorage')
        );
    }
    ...
    write_srvr() {
        ...
        this._demosrv.write_php(msg).subscribe(
            ...
            error => {
                console.error('Error saving data on server');
    ...
    read_srvr() {
        this._demosrv.read_php().subscribe(
            ...
            err => console.error(err),
            () => console.log('done load data from server')
        );
    }
